...
const Post = () => {
  ...
  return (
    <div className="flex flex-col p-1 justify-center items-center min-h-screen bg-gradient-to-br from-purple-100 via-purple-200 to-purple-50">
      ...
      <div className="grid grid-cols-1 justify-items-center w-full max-w-2xl">
          ...
          data
            ...
            ?.map((e, i) => (
              <div key={i} className="w-full mb-6">
                <PostCard data={e} openModel={handleOpenModal} cardClassName="border-2 border-purple-200 shadow-lg shadow-purple-100 rounded-xl bg-white hover:bg-purple-50 transition-all duration-300" />
              </div>
            ))
        ) : (
          !isModalOpen && (
